...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func handleQuickAction(item: UIApplicationShortcutItem) -> Bool {
        ...
        case .OpenAddNew:
            ...
            tableVC?.performSegueWithIdentifier("addRestaurant", sender: tableVC)
        }
...
//        clientKey:@"GEQ3Ij2pXE2wr5IOPxgj9nnF"];
        ...
        AVOSCloud.setApplicationId("AN5wog1d9wNYCcYRpg64j5zT-gzGzoHsz", clientKey: "GEQ3Ij2pXE2wr5IOPxgj9nnF")
