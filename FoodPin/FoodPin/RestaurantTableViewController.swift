...
class RestaurantTableViewController: UITableViewController,NSFetchedResultsControllerDelegate,UISearchResultsUpdating, UIViewControllerPreviewingDelegate {
    ...
    func previewingContext(previewingContext: UIViewControllerPreviewing, viewControllerForLocation location: CGPoint) -> UIViewController? {
        ...
        guard let detailVC = storyboard.instantiateViewControllerWithIdentifier("detailVC") as? DetailTableViewController else {
            return nil
        }
        
        let selectedShop = restaurants[indexPath.row]
        detailVC.restaurant = selectedShop
